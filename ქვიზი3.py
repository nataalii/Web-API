...
print(response.headers)
 ...
 # დავალება 2 json ფორმატის მონაცემებს შეინახავს json ფაილში სტრუქტურულად
res1 = response.json()
with open('data.json', 'w') as file:
    json.dump(res1, file, indent=4 )

# დავალება 3 წამოიღებს ინფორმაციას hotel APIდან.
...
# დავალება 4  წინა დავალებაში APIდან წამოღებულ ინფორმაციაზე დაყრდნობით ქმნის ცხრილს sqlite3 მოდულის საშუალებით
